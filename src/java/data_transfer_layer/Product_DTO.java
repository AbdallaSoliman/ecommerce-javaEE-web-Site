...
public class Product_DTO implements Serializable {
    ...
    public Product_DTO(String name, float price, int quantity, InputStream image, String category) {
        this.name = name;
        this.price = price;
    ...
    public Product_DTO(int id, String name, float price, int quantity, InputStream image, String category) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.quantity = quantity;
    ...
    public Product_DTO(int id, String name, float price, int quantity, String category) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.quantity = quantity;
