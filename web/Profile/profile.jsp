...
<html>
    ...
    <body>
        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <form action="RedirectEditProfile"  method="post" >
                <div><label id="vPromo" style="color: red">${promo}</label></div><br/> 
                ...
                <div class="styled-input agile-styled-input-top">
                    ...
                    <div><label id="vname" style="color: red"></label></div><br/> 
                                                    <!--<label name="yourName" value="${User.first_name}" ></label> -->
                    <br/>
                    <label >Name</label> ${User.first_name}
                ...
                <span class="styled-input">
                    ...
                    <label name="yourEmail" value="${User.email}"></label> 
                    <br/>
                ...
                <div class="styled-input">
                    <div><label id="vbdate" style="color: red"></label></div><br/>
                    <label name="yourDate"></label>
                    <br/>

                    <label>Birth Date</label>${User.date}

                </div>


                <div class="styled-input">
                    <div><label id="vaddress" style="color: red"></label></div><br/>
                    <label name="yourAddress"></label> 
                    <br/>
                ...
                <div class="styled-input">
                    <div><label id="vjob" style="color: red"></label></div><br/>
                    <label name="yourJob"></label> 
                    <br/>
                    <label>Job</label>${User.job}
                    <span></span>
                </div>
                ...
                <div class="styled-input"> 
                    <div><label id="vcredit" style="color: red"></label></div><br/> 
                    <label name="yourCredit"></label> 
                    <br/> 
                    <label>Credit Limit</label>${User.credit_limit}
                </div>

                <div class="styled-input">
                    <label>Interests</label>
                    <br/><br/>
                    <label name="yourInterests"></label> 
                    <br/><br/>
                </div> 
