    ...
    <body>
        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <section id="cart_items">
                <h3> your balance  : ${User.credit_limit}</h3>  
                <div class="container">
                    <form action="CartController" method="GET" name="form">
                        <input type="hidden" name="cartCommand" value="PAYMENT" />
                        <div >
                            ...
                            <button type="submit" class="agileinfo_sign">payment</i></button>
