<%-- 
    Document   : profile
    Created on : Feb 10, 2018, 10:06:16 PM
    Author     : Aya
--%>
...
<html>
    ...
    <body>
                        ...
                        <div class="col-md-8 modal_body_left modal_body_left1">
                            ...
                            <form action="/Registeration" method="post">
                                ...
                                <div class="styled-input">
                                    ...
                                    <input type="text" name="Birth Date"   id="Birth_Date" value="" onChange="validDate()" /> 
        ...
        <div class="modal-body modal-body-sub_agile">
            ...
            <h3 class="agileinfo_sign" >Profile </h3>
            <form action="EditProfile"  method="post"  enctype="multipart/form-data" onsubmit="return validForm();">
                <div><img src="${pageContext.servletContext.contextPath }/ProfilePhotoServlet?email=${User.email}" width="128" height="128"  ></div><br/>
                     <input type="file" name="imageProfile" size="50" />
                </div><br/>
                ...
                <div>
                    ...
                    <input type="Text" name="name" id="editname" value="${User.first_name}" onChange="validName()">
                    <span><label id="ename" style="color: red"></label>${promo}</span><br>
                    </div>
                ...
                <div>
                    ...
                    <div><label>Email</label></div><br>
                    <input type="Text" name="email" id="editemail" value="${User.email}" readonly> 
                    <br>
                ...
                <div>
                    ...
                    <input type="Text" name="password" id="editpassword" value="${User.password}"> 
                    <span><label id="epass" style="color: red"></label></span><br/>
                    <br/>
                ...
                <div>
                    ...
                    <div><label>Date</label></div><br>
                    <input type="Text" name="date" id="editdate" value="${User.date}" onChange="validDate()"> 
                    <span><label id="ebdate" style="color: red"></label></span><br/>
                    <br/>
                </div>
                ...
                <div >
                    ...
                    <input type="Text" name="address" id="editaddress" value="${User.address}"> 
                     <span><label id="eaddress" style="color: red"></label></span><br/>
                    <br/>
                ...
                <div>
                    ...
                    <div><label>job</label></div><br>
                    <input type="Text" name="job" id="editjob" value="${User.job}" onChange="validJob()"> 
                    <span><label id="ejob" style="color: red"></label></span><br/>
                    <br/>
                ...
                <div> 
                    ...
                    <div><label>credit</label><div><br>
                    <input type="Text" name="credit" id="editcredit" value="${User.credit_limit}" onChange="validCredit()" > 
                    <span><label id="ecredit" style="color: red"></label></span><br/>
                    <br/> 
                    ...
                    <div><label>Add your PromoCode</label><div><br>
                    <input type="Text" name="promo" id="editcredit" value=""  > 
                    <span><label id="ePromo" style="color: red"></label>${promo}</span><br/>
                    <br/> 
